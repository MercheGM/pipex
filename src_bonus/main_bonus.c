...
/*   Updated: 2025/04/21 20:39:39 by mergarci         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_hijo(int *prev_pipe, int num_commands, int *fd, int i)
{
	...
	printf("Num commands: %d, i: %d, prev_pipe[0] = %d\n", num_commands, i, prev_pipe[0]);
	if (prev_pipe[0] != -1) {
		printf("Si existe un pipe previo\n");
	...
	{
		printf("entramos aqui. prev_pipe[1]: %d\n", prev_pipe[1]);
